...
from cs.translator.elhuyar.testing import CS_TRANSLATOR_ELHUYAR_INTEGRATION_TESTING  # noqa: E501
...
class TestSetup(unittest.TestCase):
    ...
    def test_browserlayer(self):
        ...
        from cs.translator.elhuyar.interfaces import (
            ICsTranslatorElhuyarLayer)
