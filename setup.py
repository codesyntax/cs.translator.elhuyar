...
setup(
    ...
    url='https://github.com/collective/cs.translator.elhuyar',
    project_urls={
        'PyPI': 'https://pypi.org/project/cs.translator.elhuyar/',
        'Source': 'https://github.com/collective/cs.translator.elhuyar',
        'Tracker': 'https://github.com/collective/cs.translator.elhuyar/issues',
